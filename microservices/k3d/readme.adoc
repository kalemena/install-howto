...
default       traefik          LoadBalancer   10.43.42.239   192.168.208.7   80:31864/TCP,443:31047/TCP   3m44s
kube-system   kube-dns         ClusterIP      10.43.0.10     <none>          53/UDP,53/TCP,9153/TCP       5m39s
kube-system   metrics-server   ClusterIP      10.43.66.192   <none>          443/TCP                      5m39s

$ kubectl get pods --all-namespaces
NAMESPACE     NAME                                     READY   STATUS    RESTARTS   AGE
default       nginx-6799fc88d8-t5dqs                   1/1     Running   0          112s
default       svclb-traefik-mxnzn                      2/2     Running   0          5m18s
default       svclb-traefik-nm62k                      2/2     Running   0          5m18s
default       svclb-traefik-sszff                      2/2     Running   0          5m18s
default       svclb-traefik-tgdvw                      2/2     Running   1          5m18s
default       svclb-traefik-wjxmw                      2/2     Running   0          5m18s
default       svclb-traefik-zjfrx                      2/2     Running   0          5m18s
default       traefik-5fc4947cf9-2hpzw                 1/1     Running   0          5m18s
kube-system   coredns-66c464876b-8xx56                 1/1     Running   0          7m
kube-system   local-path-provisioner-7ff9579c6-5wjbm   1/1     Running   0          7m
kube-system   metrics-server-7b4f8b595-rvw8x           1/1     Running   0          7m
