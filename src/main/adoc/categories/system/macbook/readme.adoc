...
# Create the file /etc/auto_synology with the following content:
> vi /etc/auto_synology

## syn_music         -fstype=smbfs ://username:password@SynologyNAS-1/music
## syn_photos.       -fstype=smbfs ://username:password@SynologyNAS-1/photos
...
# Remove shadow on screenshots:
defaults write com.apple.screencapture disable-shadow -bool true

# script the screenshot:
> screencapture -c -x -R1,135,1271,1244
----
